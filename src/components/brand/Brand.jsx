...
const Brand = () => {
  return (
    <div className="grid md:grid-cols-5 grid-cols-3 lg:py-14 md:py-10 place-items-center text-center 2xl:px-80 xl:px-32 lg:px-20 md:px-6 px-6 md:gap-12 gap-8 md:drop-shadow-xl bg-white md:mb-14 py-10 my-10 drop-shadow-lg">
      <img
