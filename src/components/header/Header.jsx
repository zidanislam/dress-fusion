...
const Header = () => {
  ...
  return (
    <nav className="grid grid-cols-3 mx-auto 2xl:px-80 xl:px-32 lg:px-20 md:px-6 px-6 2xl:my-16 xl:my-10 lg:my-8 md:my-5 my-5">
      ...
      <div
        className={`my-auto md:text-right md:pb-2 pb-12 md:col-span-2 absolute md:static bg-white md:z-auto z-10 left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open? "top-20" : "top-[-490px]"}`}
      >
        <Link
          to="/"
        ...
        <Link to="/contact" className="text-base">
          <button className="border rounded-xl bg-black text-white drop-shadow-2xl xl:py-4 2xl:px-12 xl:px-10 lg:px-8 md:px-5 md:py-2 py-2 px-5 md:inline block ">
            Sign Up
          </button>
        </Link>
      </div>
